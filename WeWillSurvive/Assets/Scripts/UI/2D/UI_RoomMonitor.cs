...
namespace WeWillSurvive
{
    public class UI_RoomMonitor : UI_Popup
    {
        ...
        protected override void Init()
        {
            ...
            if (infos[(int)ECharacter.Lead].Status == ECharacterStatus.None || infos[(int)ECharacter.Lead].Status == ECharacterStatus.Dead)
            ...
            if (infos[(int)ECharacter.Cook].Status == ECharacterStatus.None || infos[(int)ECharacter.Cook].Status == ECharacterStatus.Dead)
            ...
            if (infos[(int)ECharacter.DrK].Status == ECharacterStatus.None || infos[(int)ECharacter.DrK].Status == ECharacterStatus.Dead)
            ...
            if (infos[(int)ECharacter.Bell].Status == ECharacterStatus.None || infos[(int)ECharacter.Bell].Status == ECharacterStatus.Dead)
